...
contract CanaryFacet {
        ...
        external isNFTOwner(_rightid)
    {
        ...
        for(uint256 i; i <= _deadlinelist.length; i++){
            ...
            require(ds.rightHolders[_rightid][_whrindexes[i]] == _deadlinelist[i],"right holder address and deadline list address is not equal");
            ...
            ds.rightHolders[_rightid][_whrindexes[i]] = ds.rightHolders[_rightid][ds.rightHolders[_rightid].length -1];
